...
export class PrismaDocumentRepository implements DocumentRepository {
  async findById(id: string): Promise<Document | null> {
    ...
    return Document.create({
      ...
      document_type: (documentRecord.document_type as 'personal' | 'academico') || undefined,
  ...
  async save(document: Document): Promise<Document> {
    ...
    return Document.create({
      ...
      document_type: (savedDocument.document_type as 'personal' | 'academico') || undefined,
  ...
  async update(document: Document): Promise<Document> {
    ...
    return Document.create({
      ...
      document_type: (updatedDocument.document_type as 'personal' | 'academico') || undefined,
